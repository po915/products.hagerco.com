    ...
    <header>
      <div className="container-fluid">
        <nav className="navbar navbar-expand-lg navbar-light">
          <a className="navbar-brand" href="https://choosehager.com/">
            <img
              className="navbar-brand-image"
              src="/public/images/hager-logo.png"
              alt="Hager Companies"
            />
          </a>
            ...
            <ul className="navbar-nav ml-auto">
              <li className="nav-item">
                <Link className="nav-link" to={routes.PRODUCTS}>
                  <img
                    ...
                    src="/public/images/icon-head-contact.svg"
                  />
              ...
              <li className="nav-item">
                <Link className="nav-link" to={routes.DIST}>
                  <img
                    className="header-links-icon"
                    src="/public/images/icon-head-distributors.svg"
                  />
                  Distributors
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to={routes.REPS}>
                  <img
                    className="header-links-icon"
                    src="/public/images/icon-head-reps.svg"
                  />
                  Reps
                </Link>
              </li>
              ...
              <li className="nav-item">
                {state.getIn(["auth", "isLoggedIn"]) ? (
                  <Link className="nav-link" to="#" onClick={logout}>
                    <img
                      className="header-links-icon"
                      src="/public/images/icon-head-login.svg"
                    />
                    Logout
                  </Link>
                ) : (
