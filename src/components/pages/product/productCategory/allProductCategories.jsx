    ...
    if (categoryList !== undefined) {
        for (let i = 0; i < categoryList.categoryList.length; i++) {
            if (categoryList.categoryList[i].images !== null) {
                renderedList.push(<ProductCategoryTile key={categoryList.categoryList[i].id} category={categoryList.categoryList[i]} />);
            }
        }
    }
        ...
        return (
            <div className="col-xl-4 col-md-6 col-sm-6 col-12 mb-4">
                <Link to={href} className="hc-card-image-wrapper">
                    <div className="hc-card-image" data-stellar-background-ratio=".5" style={{ backgroundImage: `url(${category.mainImages[0]})` }} >
